...
**Note:** AgentDecompile focuses on static analysis. For dynamic analysis, use external debuggers (gdb, x64dbg, etc.)
...
## AgentDecompile Tool Usage for CTF
