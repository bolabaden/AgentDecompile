...
The project has been successfully rebranded from **agentdecompile/agentdecompile** to **AgentDecompile** under the **Business Source License 1.1**.
...
### Old Brand (agentdecompile)
- Technical/engineering focused
- Generic "Agent Decompile"
