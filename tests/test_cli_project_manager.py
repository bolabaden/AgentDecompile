...
class TestProjectManagerInit:
    ...
    def test_creates_agentdecompile_directory_in_cwd(self, isolated_workspace: Path):
        ...
        assert not (isolated_workspace / ".agentdecompile").exists()
        ...
        assert (isolated_workspace / ".agentdecompile").exists()
        assert (isolated_workspace / ".agentdecompile" / "projects").exists()
        assert (isolated_workspace / ".agentdecompile" / "projects").is_dir()
