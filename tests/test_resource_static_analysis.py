...
class TestStaticAnalysisResource:
    ...
    def test_list_resources(self, analysis_resource):
    ...
    @pytest.mark.asyncio
    async def test_read_resource_without_program(self, analysis_resource):
    ...
    @pytest.mark.asyncio
    async def test_read_resource_with_program(self, analysis_resource):
    ...
    @pytest.mark.asyncio
    async def test_read_resource_invalid_uri(self, analysis_resource):
        """Test reading an invalid URI raises NotImplementedError."""
        with pytest.raises(NotImplementedError):
            await analysis_resource.read_resource("ghidra://invalid-uri")

    @pytest.mark.asyncio
    async def test_sarif_schema_version(self, analysis_resource):
    ...
    @pytest.mark.asyncio
    async def test_json_serializable(self, analysis_resource):
