#!/usr/bin/env python3
"""Report one-shot-source reconstruction task coverage across Recovery prompts."""
...
def main() -> int:
    ...
    if manifest.get("schema") != "agentdecompile.one-shot-source-function-reconstruction-tasks.v1":
    ...
    report = {
        "schema": "agentdecompile.one-shot-task-coverage.v1",
