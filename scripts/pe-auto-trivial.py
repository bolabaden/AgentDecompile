...
def build_rebuilt_pe_roundtrip(
    ...
    report = {
        "schema": "agentdecompile.pe-rebuilt-dll-export-roundtrip.v1",
        "binary": str(binary),
...
def build_aggregate_roundtrip(
    ...
    report = {
        "schema": "agentdecompile.pe-aggregate-source-roundtrip.v1",
        "binary": str(binary),
...
def verify_candidate(
    ...
    report = {
        "schema": "agentdecompile.pe-export-slice-verify.v1",
...
def auto_match(args: argparse.Namespace) -> int:
    ...
    with tempfile.TemporaryDirectory(prefix="recovery-pe-auto-trivial-") as tmp:
        tmp_dir = Path(tmp)
    ...
    report = {
        "schema": "agentdecompile.pe-auto-trivial.v1",
        "binary": str(binary),
        "status": "completed",
