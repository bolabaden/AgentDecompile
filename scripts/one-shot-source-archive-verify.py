...
def verify_archive(
    ...
    with tempfile.TemporaryDirectory(prefix="recovery-one-shot-archive-verify-") as tmp:
        tmp_dir = Path(tmp)
        ...
        try:
            ...
            return {
                "schema": "agentdecompile.one-shot-source-archive-verify.v1",
    ...
    if binary_evidence.get("schema") != "agentdecompile.one-shot-source-binary-evidence.v1":
    ...
    if boundary_candidates.get("schema") != "agentdecompile.one-shot-source-function-boundary-candidates.v1":
    ...
    if function_byte_slices.get("schema") != "agentdecompile.one-shot-source-function-byte-slices.v1":
    ...
    if function_slice_sources.get("schema") != "agentdecompile.one-shot-source-function-slice-sources.v1":
    ...
    if function_reconstruction_tasks.get("schema") != "agentdecompile.one-shot-source-function-reconstruction-tasks.v1":
    ...
    if function_reconstruction_results.get("schema") != "agentdecompile.one-shot-source-function-reconstruction-candidate-replay.v1":
    ...
    if not isinstance(one_shot_request_json_proof, dict):
        ...
        if one_shot_request_json.get("schema") != "agentdecompile.one-shot-source-reconstruction-request.v1":
    ...
    if not isinstance(one_shot_request_bundle_proof, dict):
        ...
        if one_shot_request_bundle.get("schema") != "agentdecompile.one-shot-source-reconstruction-request-bundle.v1":
    ...
    if one_shot_response_template.get("schema") != "agentdecompile.one-shot-source-reconstruction-response-template.v1":
    ...
    if not isinstance(structured_response_shape, dict) or structured_response_shape.get("schema") != "agentdecompile.one-shot-source-reconstruction-response.v1":
    ...
    if source_roles.get("schema") != "agentdecompile.one-shot-source-roles.v1":
    ...
    if semantic_readiness.get("schema") != "agentdecompile.one-shot-source-semantic-readiness.v1":
    ...
    if semantic_authority_evaluation.get("schema") != "agentdecompile.one-shot-source-semantic-authority-evaluation.v1":
