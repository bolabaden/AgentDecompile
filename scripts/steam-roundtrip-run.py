    ...
    for batch_index, (start, batch, batch_bytes) in enumerate(batches):
        ...
        for unit in batch:
            ...
            batch_entries.append(
                {
                    "schema": "agentdecompile.binary-source-roundtrip.v1",
                    "binary": str(binary),
                    "relativePath": rel,
...
def write_app_source_manifest(
    ...
    manifest = {
        "schema": "agentdecompile.app-source-roundtrip-manifest.v1",
        "app": app.get("name"),
        "appid": app.get("appid"),
...
def main() -> int:
    ...
    for app in selected_apps:
        ...
        if args.semantic_match_mode == "auto" and ok and target:
            ...
            if match_report is None:
                ...
                matched_functions = {
                    "schema": "agentdecompile.app-function-matches.v1",
                    "app": app.get("name"),
                    "binary": str(binary),
        ...
        if pe_reports:
            ...
            (app_dir / "matched-pe-export-functions.json").write_text(
                json.dumps(
                    {
                        "schema": "agentdecompile.app-pe-export-function-matches.v1",
                        "app": app.get("name"),
    ...
    report = {
        "schema": "agentdecompile.steam-roundtrip-run.v1",
