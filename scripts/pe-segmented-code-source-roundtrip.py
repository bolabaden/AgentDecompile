...
def main() -> int:
    ...
    report = {
        "schema": "agentdecompile.pe-segmented-code-source-roundtrip.v1",
        "status": "matched",
        "binary": str(binary),
        "package": str(package),
        ...
        "claimBoundary": (
            "Code sections are rebuilt from segmented C source. Verified-function segments come from imported Recovery "
