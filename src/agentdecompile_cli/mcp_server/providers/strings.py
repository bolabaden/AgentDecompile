            ...
            types.Tool(
                ...
                inputSchema={
                    ...
                    "properties": {
                        ...
                        "limit": {"type": "integer", "default": 100, "description": "Number of strings to return. Typical values are 100–500. Do not set this below 50 unless the user explicitly asks for only a handful of results."},
            ...
            types.Tool(
                ...
                inputSchema={
                    ...
                    "properties": {
                        ...
                        "limit": {"type": "integer", "default": 100, "description": "Number of results to return. Typical values are 100–500. Do not set this below 50 unless the user explicitly asks for only a handful of results."},
                        "offset": {"type": "integer", "default": 0, "description": "Pagination offset."},
                    },
                    "required": ["query"],
                },
