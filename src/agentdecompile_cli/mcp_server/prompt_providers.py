...
_PROMPTS: list[dict[str, Any]] = [
        ...
        "messages": [
            {
                ...
                "text": (
                    ...
                    "Identify every callee and decompile any not yet covered.\n\n"
    ...
    # 7. Bridge Builder – Cross-Binary Parity
    {
        ...
        "description": (
            ...
            "different platform builds). Uses function matching to propagate names, "
            "comments, and types across binaries."
        ),
        "arguments": [
        ...
        "messages": [
            {
                ...
                "text": (
                    ...
                    "2. Use `match-function` to carry over function matches from source to target\n"
                    "3. Propagate names, comments, and tags for high-similarity matching functions\n"
                    "4. Focus on the core routines already analysed in the source binary\n\n"
                    "## Approach\n"
                    "- First, list functions in the source binary related to the subsystem\n"
                    "- For each function, use `match-function` against the target binary\n"
                    "- For successful matches (high similarity), propagate annotations\n"
                    "- Document any functions that did not match or had low confidence\n\n"
                    "## Output\n"
                    "Return a report on:\n"
                    "1. Both binaries verified and accessible\n"
                    "2. Total functions attempted vs successfully matched\n"
                    "3. Annotations propagated for each match\n"
                    "4. Functions that failed to match and possible reasons\n"
