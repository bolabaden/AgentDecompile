...
def has_bsim() -> bool:
    ...
    return hasattr(vtapi, "BSimProgramCorrelatorFactory")


def add_bsim_args_to_parser(parser: argparse.ArgumentParser) -> None:
...
def gen_bsim_sigs_for_program(
    prog: ghidra.program.model.listing.Program,
    sigs_path: Path,
    bsim_template: str,
    categories: Sequence[str] | None = None,
    all_funcs: Sequence[ghidra.program.model.listing.Function] | None = None,
) -> tuple[str, int, int]:
