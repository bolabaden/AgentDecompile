 ...
 */
public class ProjectToolProviderVersionControlIntegrationTest extends AgentDecompileIntegrationTestBase {
    ...
    public void testCheckinProgram() throws Exception {
        withMcpClient(createMcpTransport(), client -> {
            ...
            try {
                ...
                if (testProgram != null) {
                    AgentDecompileProgramManager.unregisterProgram(testProgram);
                    if (serverManager != null) {
    ...
    public void testUncheckoutOperation() throws Exception {
        withMcpClient(createMcpTransport(), client -> {
            ...
            try {
                ...
                // Release program from cache
                AgentDecompileProgramManager.releaseProgramFromCache(testProgram);
                AgentDecompileProgramManager.unregisterProgram(testProgram);
