 ...
 */
public class DecompilerToolProviderIntegrationTest extends AgentDecompileIntegrationTestBase {
    ...
    public void setUp() throws Exception {
        ...
        // Open the program in the tool's ProgramManager so it can be found by AgentDecompileProgramManager
        env.open(program);
    ...
    public void testSearchDecompilationRespectsMaxFunctionLimitConfig() throws Exception {
        ...
        agentdecompile.plugin.ConfigManager configManager = agentdecompile.util.AgentDecompileInternalServiceRegistry.getService(agentdecompile.plugin.ConfigManager.class); 
