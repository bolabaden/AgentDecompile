 ...
 */
public class StructureToolProviderIntegrationTest extends AgentDecompileIntegrationTestBase {
    private String program_path;

    @Before
    public void setUpStructureTests() throws Exception {
        // Get program path for use in tests - this is how AgentDecompileProgramManager identifies programs
