...
/**
 * Integration tests for the MCP server functionality in AgentDecompilePlugin
 */
public class AgentDecompilePluginMcpIntegrationTest extends AgentDecompileIntegrationTestBase {
    ...
    public void setUpMcpTest() throws Exception {
        ...
        configManager = agentdecompile.util.AgentDecompileInternalServiceRegistry.getService(ConfigManager.class);
     ...
     *
     * Background: Previously, AgentDecompileProgramManager.getProgramByPath() failed in test environments
     * because ToolManager.getRunningTools() returned empty arrays. The fix added a fallback
     * mechanism to check the AgentDecompilePlugin tool directly.
     */
    @Test
