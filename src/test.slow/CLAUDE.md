...
All integration tests extend `AgentDecompileIntegrationTestBase` which provides:
...
```java
public class MyToolIntegrationTest extends AgentDecompileIntegrationTestBase {
