...
import agentdecompile.debug.DebugInfoCollector;
...
public class AgentDecompileDebugInfoResource extends AbstractResourceProvider {
    ...
    private static final String RESOURCE_NAME = "agentdecompile-debug-info";
    private static final String RESOURCE_DESCRIPTION = "AgentDecompile debug information including system info, Ghidra config, AgentDecompile settings, MCP server status, and open programs";
    ...
    public AgentDecompileDebugInfoResource(McpSyncServer server) {
        super(server);
