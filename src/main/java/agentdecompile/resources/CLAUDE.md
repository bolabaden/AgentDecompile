...
This file provides guidance for Claude Code when working with the MCP resource provider system in the `agentdecompile.resources` package.
...
The `agentdecompile.resources` package implements the Model Context Protocol (MCP) resource provider system, exposing read-only Ghidra data through MCP resources. Unlike tool providers that execute actions, resource providers make data available for client consumption.
...
- `/src/main/java/agentdecompile/server/CLAUDE.md` - Server architecture, provider registration
- `/src/main/java/agentdecompile/tools/CLAUDE.md` - Tool provider patterns (for comparison)
- `/src/main/java/agentdecompile/plugin/CLAUDE.md` - AgentDecompileProgramManager, program lifecycle
- `/src/main/java/agentdecompile/util/CLAUDE.md` - Utility classes for data access
