...
The `agentdecompile.tools.memory` package provides MCP tools for memory analysis and manipulation in Ghidra programs. It handles reading memory content, listing memory blocks, and provides utilities for safe memory access patterns.
