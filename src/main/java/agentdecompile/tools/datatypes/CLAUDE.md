...
This file provides guidance to Claude Code when working with the datatypes tools package in AgentDecompile.

## Package Overview

The `agentdecompile.tools.datatypes` package provides MCP tools for data type management and operations in Ghidra. It enables AI-assisted exploration and manipulation of data type archives, including built-in types, program-specific types, and user-defined types.
...
- Use `AgentDecompileIntegrationTestBase` for Ghidra environment setup
