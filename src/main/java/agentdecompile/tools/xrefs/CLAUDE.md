...
The `agentdecompile.tools.xrefs` package provides MCP tools for comprehensive cross-reference analysis in Ghidra programs. It enables finding and analyzing references to and from memory locations, symbols, and functions with optional decompilation context snippets for enhanced code understanding.
