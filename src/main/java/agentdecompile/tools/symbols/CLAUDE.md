...
This file provides guidance to Claude Code when working with the symbols tools package in AgentDecompile.

## Package Overview

The symbols tools package (`agentdecompile.tools.symbols`) provides MCP tools for interacting with Ghidra's symbol table operations. This includes retrieving symbol information with pagination, counting symbols, listing imports/exports, creating labels, renaming data, and understanding symbol metadata across programs.
