...
The `agentdecompile.tools.decompiler` package provides MCP tools for function decompilation and variable manipulation. It handles Ghidra's decompiler interface and implements read-before-modify tracking to ensure safe variable operations.
