...
The `agentdecompile.tools.bookmarks` package provides MCP tools for bookmark management in Ghidra programs. It enables creation, retrieval, modification, and deletion of bookmarks which are essential for tracking important locations, notes, and analysis findings during reverse engineering workflows.
