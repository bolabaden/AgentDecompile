...
This file provides guidance to Claude Code when working with the suggestions tool provider in AgentDecompile.

## Package Overview

The `agentdecompile.tools.suggestions` package provides context-aware suggestions for reverse engineering analysis. It helps users discover appropriate names, comments, data types, and function tags based on program context and patterns.
...
- Suggestions can be applied using other AgentDecompile tools (function creation, variable renaming, etc.)

## Integration with Other Tools

Suggestions work well with other AgentDecompile tools:
