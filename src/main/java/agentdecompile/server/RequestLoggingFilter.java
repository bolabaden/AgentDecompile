/*
 * Copyright (c) 2024-2025 The AgentDecompile authors
...
public class RequestLoggingFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
        ...
        // Request logging mode: Log full HTTP request/response to agentdecompile-tools.log
    ...
    /**
     * Filter with full request/response body logging to agentdecompile-tools.log.
     */
    private void doFilterWithBodyLogging(HttpServletRequest request, HttpServletResponse response,
        ...
        AgentDecompileToolLogger.logHttpRequest(
            requestId,
            request.getMethod(),
        ...
        try {
            ...
            AgentDecompileToolLogger.logHttpResponse(
                requestId,
