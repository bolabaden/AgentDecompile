...
/**
 * Ghidra file system implementation (template/skeleton).
 * <p>
 * Ghidra API: {@link ghidra.formats.gfilesystem.GFileSystem}, {@link ghidra.formats.gfilesystem.FileSystemIndexHelper},
 * {@link ghidra.app.util.bin.ByteProvider} -
 * <a href="https://ghidra.re/ghidra_docs/api/ghidra/formats/gfilesystem/GFileSystem.html">GFileSystem API</a>.
...
public class agentdecompileFileSystem implements GFileSystem {
	...
	public agentdecompileFileSystem(FSRLRoot fsFSRL, ByteProvider provider) {
		...
		// Ghidra API: FileSystemIndexHelper - https://ghidra.re/ghidra_docs/api/ghidra/formats/gfilesystem/FileSystemIndexHelper.html
	...
	/**
	 * Factory and probe for this file system type.
	 * Ghidra API: {@link GFileSystemFactoryByteProvider}, {@link GFileSystemProbeByteProvider} -
	 * <a href="https://ghidra.re/ghidra_docs/api/ghidra/formats/gfilesystem/factory/GFileSystemFactoryByteProvider.html">GFileSystemFactoryByteProvider API</a>.
	 */
