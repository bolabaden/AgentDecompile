 ...
 */
package agentdecompile.tools.callgraph;
...
public class CallGraphToolProviderTest {
    ...
    public void testInheritance() {
        ...
        assertTrue("CallGraphToolProvider should extend AbstractToolProvider",
            agentdecompile.tools.AbstractToolProvider.class.isAssignableFrom(CallGraphToolProvider.class));
    }
    ...
    public void testToolProviderInterface() {
        ...
        assertTrue("CallGraphToolProvider should implement ToolProvider",
            agentdecompile.tools.ToolProvider.class.isAssignableFrom(CallGraphToolProvider.class));
    }
