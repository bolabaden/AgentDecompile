 ...
 */
package agentdecompile.tools.vtable;
...
public class VtableToolProviderTest {
    ...
    public void testInheritance() {
        ...
        assertTrue("VtableToolProvider should extend AbstractToolProvider",
            agentdecompile.tools.AbstractToolProvider.class.isAssignableFrom(VtableToolProvider.class));
    }
    ...
    public void testToolProviderInterface() {
        ...
        assertTrue("VtableToolProvider should implement ToolProvider",
            agentdecompile.tools.ToolProvider.class.isAssignableFrom(VtableToolProvider.class));
    }
